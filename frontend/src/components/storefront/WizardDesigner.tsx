...
export function WizardDesigner({ productId, shop, config }: WizardDesignerProps) {
    return (
        <div className="imcst-wizard-container border rounded-xl overflow-hidden bg-white shadow-lg my-4 h-[600px] flex flex-col">
            <div className="bg-gray-50 px-6 py-3 border-b flex justify-between items-center">
                <h3 className="font-bold text-gray-700">{config?.headerTitle || 'Guide: Step-by-Step Personalization'}</h3>
